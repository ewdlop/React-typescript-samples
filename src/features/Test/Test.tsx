...
import './Test.css';
import image from './pngguru.com.png';
            ...
            <div>
                ...
                <div className="parallax-image img2 gap">
                    <div className="masonry">
                        ...
                        <div className="item">
                            <img src='https://lh3.googleusercontent.com/proxy/4UyMvTUX5_7LTO_XVaZwWtKXK0-Z53py6-pKrFIr0GmXZuIVqKC9QHPTZCm-eyrlA_l86OEQkHA6xIfcvig3s1TWFSqSZlmBxGEZd9v3a3iugU4CBLLZyNAjli4' />
                            <div className="overlay">
                                <div className="text">Hello World</div>
                            </div>
                        </div>
